...
describe('Header', () => {
  it('renders the CubeSat Ground Station title', () => {
    render(<Header latest={null} isLoading={false} isError={false} />)
  ...
  it('shows the OBC state badge when latest data is provided', () => {
    render(<Header latest={mockRecord} isLoading={false} isError={false} />)
    expect(screen.getByText('NOMINAL')).toBeInTheDocument()
  })

  it('shows "API Offline" text when isError=true', () => {
    render(<Header latest={null} isLoading={false} isError={true} />)
